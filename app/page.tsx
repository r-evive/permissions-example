...
export default function Home() {
  return (
    <div className="space-y-4">
      <AccessAlert hasAccess={true} requiredPermissions={[]} />
      <Hint title="PS. Everyone has access to this page!" variant={HintVariant.INFO}>This page is accessible to everyone.
